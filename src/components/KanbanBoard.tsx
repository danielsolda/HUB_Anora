    ...
    <div className="flex h-full flex-col">
      ...
      {!loading && source === 'sample' ? (
        <div className="mx-5 mt-4 rounded-lg border border-mauve/30 bg-sand/20 px-4 py-2.5 text-sm text-ink/70 sm:mx-6">
          Modo demonstração — não foi possível ler a planilha ao vivo neste
          navegador. Verifique se ela está compartilhada como “qualquer pessoa com o
          link”.{' '}
          <a
            href={SHEET_EDIT_URL}
            target="_blank"
